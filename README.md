...
[אוריאן גייסמן](https://github.com/auriyan)

[נחשון רייניץ](https://github.com/Nreinitz)


יצרנו פרוייקט בקורס בסיסי נתונים ובחרנו לבנות מערכת סקי🏂⛷


![image](https://github.com/user-attachments/assets/359f014a-5fcc-43cc-b991-3ee19f254cd4)


לתשומת ליבכם הכנו קובץ דרישות שתוכלו להבין על מה הפרוייקט, ובנוסף בשלב 3 דילגנו על האינטגרציה בגלל תקלה טכנית.
